...
public class updtattendance extends HttpServlet
{
   ...
   try
    {
        ...
        String q1="update atdnc set NM='"+nm+"', LUPDT='"+lupdt+"', ATDNC='"+atdnc+"', TATDNC='"+tatdnc+"' where RNO='"+rno+"'";
        int x=stmt.executeUpdate(q1);
        if(x>0)
    {
        pw1.println("updated.... <a href=admin.html>go to Home page</a>");
       
       }
       else
       {
         System.out.println("Not found... <a href=admin.html>go to Home page</a> ");
       }
     con.close();
     }
     catch(Exception e)
